...
public class MainActivity extends AppCompatActivity {
    ...
    private void setCategories() {
        ...
        modelCategoriesList.add(modelCategories);
        modelCategories = new ModelCategories(R.drawable.ic_fast, "Fast Food");
        modelCategoriesList.add(modelCategories);
        modelCategories = new ModelCategories(R.drawable.ic_event, "Event Package");
        modelCategoriesList.add(modelCategories);
    ...
    private void setTrending() {
        modelTrending = new ModelTrending(R.drawable.complete_1,"Menu 1", "2.200 Likes");
        modelTrendingList.add(modelTrending);
        modelTrending = new ModelTrending(R.drawable.complete_2,"Menu 2", "1.220 Likes");
        modelTrendingList.add(modelTrending);
        modelTrending = new ModelTrending(R.drawable.complete_3,"Menu 3", "345 Likes");
        modelTrendingList.add(modelTrending);
        modelTrending = new ModelTrending(R.drawable.complete_4,"Menu 4", "590 Likes");
        modelTrendingList.add(modelTrending);
